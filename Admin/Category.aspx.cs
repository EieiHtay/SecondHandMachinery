...
public partial class Admin_Category : System.Web.UI.Page
{
    ...
    MainDataSetTableAdapters.AllowProductTableAdapter AllowProductTbl = new MainDataSetTableAdapters.AllowProductTableAdapter();
    ...
    protected void DisplayCategory()
    {
        ...
        rCategory.DataSource = DtDisplay;
        rCategory.DataBind();
    ...
    {
        Dt = CategoryTbl.Category_Select_By_SearchCatName(txtSearch.Text.Trim().ToString());
        DisplayCategory();
    }
    protected void btnDelete_Click(object sender, EventArgs e)
    {
       ...
       (AllowProductTbl.AllowProduct_Select_By_CatID(Convert.ToInt32(txtCatID.Text)).Rows.Count > 0)
        {
