...
public partial class Admin_Product : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (btnSave.Text == "Save")
            {
                ...
                ProductTbl.Product_Insert(Convert.ToInt32(ddlCategoryName.SelectedValue), txtProductName.Text, Convert.ToInt32(txtPrice.Text.ToString()), Convert.ToInt32(txtQuantity.Text.ToString()),txtDesc.Text,"false");
            ...
            else if (btnSave.Text == "Update")
            {
                ...
                ProductTbl.Product_Update(Convert.ToInt32(txtProductID.Text), Convert.ToInt32(ddlCategoryName.SelectedValue), txtProductName.Text, Convert.ToInt32(txtPrice.Text), Convert.ToInt32(txtQuantity.Text),txtDesc.Text, ImagePath.ToString());
             }
            ClearData();
            Dt = ProductTbl.GetData();
            DisplayProduct();
    ...
    protected void txtSearch_TextChanged(object sender, EventArgs e)
    {
        if (ddlSearchType.SelectedIndex == 0)
            ...
            Dt = ProductTbl.Product_Select_By_Search_CatName(txtSearch.Text);
        else if (ddlSearchType.SelectedIndex == 2)
            Dt = ProductTbl.Product_Select_By_Search_Price(txtSearch.Text);
        else if (ddlSearchType.SelectedIndex == 3)
            Dt = ProductTbl.Product_Select_By_Search_Quantity(txtSearch.Text);
