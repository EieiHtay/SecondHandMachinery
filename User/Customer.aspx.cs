...
public partial class User_Customer : System.Web.UI.Page
{
    ...
    protected void signup_Click(object sender, EventArgs e)
    {
        ...
        {
            lblError.Text = "Please Enter NRC";
            txtEmail.Focus();
        }
        ...
        {
            CustomerTbl.Customer_Insert(txtCustomerName.Text, txtAddress.Text, txtPhone.Text,txtNrc.Text,
               txtEmail.Text, txtPassword.Text, ddlCType.SelectedItem.ToString(), txtANo.Text);
